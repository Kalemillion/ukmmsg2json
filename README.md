...
Extracts text entries from *The Legend of Zelda: Breath of the Wild* message files (`.sarc` / `.msbt`), from both UKMM's compressed CBOR format and raw game dumps. Edit the JSON, then convert back to a UKMM-ready `.sarc`.
